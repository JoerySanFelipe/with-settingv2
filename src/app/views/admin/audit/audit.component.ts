...
export class AuditComponent implements OnInit {
  ...
  onRoleChange(): void {
    ...
    this.displayedAuditLog = this._auditLog.filter(log => {
      const roleFilter = !this.selectedRole || this.selectedRole === 'null' || log.role === this.selectedRole;
      const componentFilter = !this.selectedComponent || this.selectedComponent === 'null' || log.component === this.selectedComponent;
      const actionFilter = !this.selectedAction || this.selectedAction === 'null' || log.action === this.selectedAction;
